 ...
 * Time: 8:45 AM
 */
class Pivodirtjumper_RuleRelation_Model_Rulerelation_Display_Condition_Combine
    extends Mage_Rule_Model_Condition_Combine
{
    ...
    public function __construct()
    {
        ...
        $this->setType('pivodirtjumper_rulerelation/rulerelation_display_condition_combine');
    }
    ...
    public function getNewChildSelectOptions()
    {
        ...
        $conditions = array_merge_recursive($conditions, array(
            array('value'=>'pivodirtjumper_rulerelation/rulerelation_display_condition_combine', 'label'=>Mage::helper('catalog')->__('Conditions Combination')),
    ...
    /*public function getNewChildSelectOptions()
    {
        ...
        $conditions = array_merge_recursive($conditions, array(
            array(
                'value' => 'pivodirtjumper_rulerelation/rulerelation_display_condition_combine',
        ...
        Mage::dispatchEvent('pivodirtjumper_rulerelation_rule_display_condition_combine', array('additional' => $additional));
